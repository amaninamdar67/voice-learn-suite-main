...
import { MessageCircle, ThumbsUp, Send, X, Eye, EyeOff, FileText, Edit2, Trash2 } from 'lucide-react';
...
export default function AssignmentsCommunity() {
  const { user } = useAuth();
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Assignments Discussion</h1>
          </div>
          <p className="text-gray-600">Discuss assignments, submissions, and project work</p>
        </div>
        {canComment && (
          <button
          ...
          <div key={post.id} className="bg-white rounded-lg shadow-md p-6 relative">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {canSeeRealIdentity && (
                    <span className="px-2 py-0.5 bg-blue-100 text-orange-600 text-xs rounded">
            ...
            {!editingPost && post.user_id === user?.id && (
              <button
                ...
                className="absolute bottom-4 right-4 text-gray-400 hover:text-orange-600 transition-colors flex items-center gap-1 text-sm"
              >
                <Edit2 size={16} />
                <span>Edit</span>
              </button>
                        ...
                        <>
                          ...
                          {reply.user_id === user?.id && (
                            <button
                              ...
                              className="mt-1 text-gray-400 hover:text-orange-600 transition-colors flex items-center gap-1 text-xs"
                            >
                              <Edit2 size={12} />
                              <span>Edit</span>
                            </button>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600 mt-1">Share your thoughts about assignments</p>
              </div>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="Share your thoughts about assignments..."
                />
              </div>
