...
export default function RecordedClassesCommunity() {
  const { user } = useAuth();
  ...
  const fetchPosts = async () => {
    try {
      ...
      // Fetch all posts, not just recorded-classes category
      // This allows seeing comments from all sources
      let query = supabase
        .from('community_posts')
        .select('*')
        .order('created_at', { ascending: false });
      
      // Optionally filter by category if you want strict filtering
      // Uncomment the line below to only show recorded-classes posts
      // query = query.eq('category', 'recorded-classes');
  ...
  const handleReply = async (postId: string) => {
    if (!canComment) {
      alert('Only students and teachers can reply');
      return;
    }
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Recorded Classes Discussion</h1>
          </div>
          <p className="text-gray-600">Discuss recorded video lessons and share insights</p>
        </div>
        {canComment && (
          <button
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600 mt-1">Share your thoughts about recorded classes</p>
              </div>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="Share your thoughts about recorded classes..."
                />
              </div>
