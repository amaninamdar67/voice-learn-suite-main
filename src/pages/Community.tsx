...
import { MessageCircle, ThumbsUp, Send, X, Eye, EyeOff } from 'lucide-react';
...
export default function Community() {
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      setNewPost({ title: '', content: '', subject: '', is_anonymous: true });
      fetchPosts();
    } catch (error: any) {
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                {newPost.is_anonymous ? <EyeOff size={20} /> : <Eye size={20} />}
                <span className="text-sm text-blue-900">
                  Posting as: <strong>Anonymous</strong> (Your identity is protected)
                </span>
              </div>
